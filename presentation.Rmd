...
diabetes_drugs <- CodelistGenerator::codesFromConceptSet("concept_sets/drugs_for_diabetes.json", cdm)
heart_failure <- CodelistGenerator::codesFromConceptSet("concept_sets/heart_failure.json", cdm)
